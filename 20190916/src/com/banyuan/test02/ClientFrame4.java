 ...
 *
 */
public class ClientFrame4 extends JFrame implements ActionListener {
	...
	public static void main(String[] args) {
		ClientFrame4 frame = new ClientFrame4();
...
//		});
	...
	public ClientFrame4() {
		...
		try {
			s = new Socket("192.168.11.22", 10000, InetAddress.getByName("192.168.11.22"), 10004);
